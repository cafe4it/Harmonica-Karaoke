if (Meteor.isClient) {
    Template.karaoke.helpers({
        game: function () {
            $(document).ready(function(){
                game = new Phaser.Game(1024, 600, Phaser.AUTO, "game", {preload: preload, create: create, update: update});
    ...
    var create = function () {
        ...
        _phachBatDau = game.add.text(50,50,'0',{font : '36px Arial',fill : 'green',align : 'left'})
        var notes = [
            {id: 0, text: "|",tab : ''},
            {id: 1, text: 'Đồ', tab: 4},
            {id: 2, text: 'Rê', tab: -4},
        ...
        var notDen = 1284, denChamDoi = notDen * 1.5, mocDon = notDen / 2, trangChamDoi = notDen * 2.5, notTrang = notDen * 2;
